			...
			<div class="main-container-inner">
						            ...
						            <div class="panel panel-primary">
							            ...
							            <div class="table-responsive">
							             	<div class="container-fluid">
											    <div class="row-fluid">
											        <div class="span12">										
											            <form action="/Admin/Img/index" method="get">
												            <div class="table-responsive">
              ...
              未审核
                        ...
                        <td>
                            ...
                            <a href="http://<?php echo ($domain); echo ($v["himg"]); ?>" class='btn btn-warning btn-xs'>查看</a> 
                            <a href="<?php echo U('Admin/Img/delimg',array('id'=>$v['id']));?>" class='btn btn-danger btn-xs'>删除</a> 
                        </td>
