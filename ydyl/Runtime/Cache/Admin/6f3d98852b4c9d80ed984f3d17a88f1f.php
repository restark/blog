...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>金诺华后台管理</title>
		<meta name="keywords" content="金诺华后台管理" />
		<meta name="description" content="金诺华后台管理" />
		...
		<div class="navbar navbar-default" id="navbar">
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					<a href="<?php echo U(GROUP_NAME.'/Index/index');?>" class="navbar-brand">
						<small>
							<i class="icon-leaf"></i>
							ydyl后台管理系统
						</small>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li>
									<a href="<?php echo U(GROUP_NAME.'/System/password');?>">
										<i class="icon-cog"></i>
										修改密码
									</a>
								</li>
			...
			<div class="main-container-inner">
									...
									<div class="panel panel-primary">
										...
										<div class="table-responsive">
											<div class="container-fluid">
												<div class="row-fluid">
													<div class="span12">
														<form action="/admin/category/sortCate" method="post">
															<div class="table-responsive">
              ...
              未审核
                     ...
                     <?php if(is_array($type)): foreach($type as $key=>$t): if($v['tid']===$t['id']): echo ($t["name"]); endif; endforeach; endif; ?>
                        ...
                        <td>
                             <a href="<?php echo U(GROUP_NAME.'/News/renews',array('id'=>$v['id']));?>" class='btn btn-warning btn-xs'>还原</a> 
                            <a href="<?php echo U(GROUP_NAME.'/News/delnews',array('id'=>$v['id']));?>" class='btn btn-danger btn-xs'>删除</a> 
                        </td>
