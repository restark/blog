...
<head>
  ...
  <link rel="stylesheet" href="/Public/css/lookdata.css">
...
<script type="text/javascript">
  ...
  <div class="twoNav">
    <ul>
      <li class="twoli">数据查询</li>
    </ul>
  </div>
  <!-- 新闻主体 -->
  <div class='dataMain'>
    <ul class="dataTitle">
      <li class="datachange">国别宏观</li>
      <li>中国宏观</li>
      <li>投资贸易</li>
      <li>地方统计</li>
    </ul>
    <div class="datadelect">
      <select class="country" name="">
        <option>请选择国家</option>
      </select>
      <select class="zhibiao" name="" id="">
        <option value="">请选择指标</option>
      </select>
      <select class="year1" name="" id="">
        <option value="">请选择年份</option>
      </select>
      <span>——</span>
      <select class="year2" name="" id="">
        <option value="">请选择年份</option>
      </select>
...
$(function () {
  ...
  $(".dataTitle>li").on("click",function () {
    $(this).addClass("datachange").siblings().removeClass("datachange");
  })
  $(".search").keyup(function(event) {
    if (event.keyCode == 13) {
      var search = $(this).val();
