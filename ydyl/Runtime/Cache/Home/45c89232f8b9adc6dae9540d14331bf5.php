...
<head>
  ...
  <link rel="stylesheet" href="/Public/css/chanye.css">
  ...
  <script type="text/javascript" src="/Public/js/chanye.js"></script>
</head>
<body>
  <!-- 顶部图片 -->
  ...
  <div class="daohang">
    <ul class="daohangNav">
      <li><a href="http://www.cupoftea.cn/index/index.html">网站首页</a></li>
      <li><a href="">时政新闻</a></li>
      <li><a href="">政策环境</a></li>
      <li><a href="">大数据云</a></li>
      <li><a href="">智库建设</a></li>
      ...
      <li><a href="">国际合作</a></li>
      <li><a href="">安全应急</a></li>
      <li><a href="http://www.cupoftea.cn/index/chanye.html">产业大联盟</a></li>
  ...
  <div class="sichou">
    <div class="oneTitle clear">
      ...
      <div class="titleNav">
        <!-- 一带一路一行导航 -->
        <a href="http://www.people.com.cn/" target="_blank"><div class="titleBlue">
  ...
  <div class="inTimeNew">
    ...
    <div class="roll-wrap roll_row" id="e" style="width: 1030px;">
  ...
  <div class="mainNew clear">
    ...
    <div class="mainRight">
      ...
      <div class="secondNav">
        <div class="secondTitle">联盟成员单位</div>
        <div class="chengyuan">
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    success:function (msg) {
      ...
      //   for(var msg1 of msg){
      //     if(msg1.name == "知识产权" || msg1.name == "产业大联盟" || msg1.name == "物资大流通"){
      //
      //     }else{
      //       if($(this).text() == msg1.name){
      //         $(this).attr({
      //           "href":"http://www.cupoftea.cn/Index/indextwo#"+ msg1.name +"?"+ msg1.id +"",
      //           "target":"_blank"
      //         });
      //       }
      //     }
